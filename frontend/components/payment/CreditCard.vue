  ...
  <div class="wrapper" id="app">
    <div class="card-form">
            ...
            <div class="card-item__wrapper">
              ...
              <div class="card-item__content">
                <label for="cardName" class="card-item__info" ref="cardName">
                  <div class="card-item__holder">Имя владельца</div>
                  <transition name="slide-fade-up">
      ...
      <div class="card-form__inner">
        ...
        <div class="card-input">
          <label for="cardName" class="card-input__label">Имя владельца</label>
        ...
        <div class="card-form__row">
          <div class="card-form__col">
            <div class="card-form__group">
              <label for="cardMonth" class="card-input__label">Действительна до</label>
        ...
        <v-checkbox
            v-model="receiptToEmail"
            :label="`Отправить квитанцию на ${userId}`"
        ></v-checkbox>
        <v-btn dark color="primary" @click="payAndLaunch()">
          <v-icon
              left
              dark>
            {{mdiLocker}}
          </v-icon> Оплатить 1000₽
        </v-btn>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    async loadUser() {
      ...
      if (!!userId) this.user = await this.$axios.$get(`/user/${userId}`)
      else console.warn('User id is null');
    ...
    async payAndLaunch() {
      ...
      const balance = '1000';
      //todo Сохранить карту и баланс для юзера
      this.user.cardNumber = cardNumber;
      this.user.cardType = cardType;
      this.user.balance = balance;
      this.user.isFishingStarted = true;
      const user = await this.$axios.$post('/user', this.user);
      this.UPDATE_USER(user);
      this.$router.push(`/dashboard/personal?id=${this.user.email}`)
    }
  }
}
</script>
