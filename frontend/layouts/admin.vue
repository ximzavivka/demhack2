...
<script>
import MenuListAdmin from '@/components/navigation/MenuListAdmin.vue'
import {mdiCommentProcessingOutline, mdiFacebook, mdiInstagram, mdiMenu, mdiSignal,mdiLocationEnter} from '@mdi/js'
...
export default {
  ...
  data() {
    return {
      ...
      mdiMenu: mdiMenu, mdiSignal,mdiLocationEnter,
      goDark: false,
      drawer: false,
